defmodule Hermes.Kanbans do
  ...
  def get_board!(board_id, current_user_team_id) do
    ...
    columns = [
      ...
      %{
        id: 7,
        name: Gettext.gettext(HermesWeb.Gettext, "Need requirement"),
        position: 1,
        status: "need_requirement"
      },
      %{
        id: 2,
      ...
      %{
        id: 9,
        name: Gettext.gettext(HermesWeb.Gettext, "Todo in Sprint"),
        position: 4,
        status: "todo_in_sprint"
      },
      %{
        id: 3,
      ...
      %{id: 4, name: Gettext.gettext(HermesWeb.Gettext, "Review"), position: 6, status: "review"},
      %{
        id: 6,
